const CitiesList = [
    {  
        location: "Haifa",
        name: "Haram Al-Sharif (Temple Mount)",
        image: "https://www.planetware.com/photos-large/ISR/israel-jerusalem-dome-of-the-rock.jpg",
        description: [
            "Follow in the footsteps of centuries of pilgrims, and enter one of the holiest sanctuaries on earth.", 
            "Lauded by Jews, Christians, and Muslims, this is the site where Abraham (father of all three monotheistic faiths) is said to have offered his son up as a sacrifice to God, where Solomon built the First Temple for the Ark of the Covenant, and where the Prophet Muhammad is said to have ascended to heaven during his early years of preaching Islam.",
            "It's a place of deep significance (and contention over ownership) for those of faith.",
            "The wide plaza, above the Old City, is centered around the glittering Dome of the Rock, which is Jerusalem's most iconic landmark. Beneath the golden dome is the sacred stone both Jews and Muslims believe to be where Abraham offered his son to God and where Muslims also believe the Prophet Muhammad began his journey to heaven."
        ]
    }, 
    {
        location: "Haifa",
        name: "Western Wall and Jewish Quarter",
        image: "https://www.planetware.com/photos-large/ISR/israel-jerusalem-wailing-wall-and-jewish-quarter.jpg",
        description: [
